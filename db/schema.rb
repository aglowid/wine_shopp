...
ActiveRecord::Schema.define(version: 20170904065709) do
  ...
  create_table "spree_orders_subscriptions", force: :cascade do |t|
    ...
    t.index ["order_id"], name: "index_spree_orders_subscriptions_on_order_id", using: :btree
    t.index ["subscription_id"], name: "index_spree_orders_subscriptions_on_subscription_id", using: :btree
  end
  ...
  create_table "spree_product_subscription_frequencies", force: :cascade do |t|
    ...
    t.index ["product_id"], name: "index_spree_product_subscription_frequencies_on_product_id", using: :btree
  end
  ...
  create_table "spree_products", force: :cascade do |t|
    ...
    t.index ["is_subscribable"], name: "index_spree_products_on_is_subscribable", using: :btree
  ...
  create_table "spree_subscriptions", force: :cascade do |t|
    ...
    t.index ["bill_address_id"], name: "index_spree_subscriptions_on_bill_address_id", using: :btree
    t.index ["cancelled_at"], name: "index_spree_subscriptions_on_cancelled_at", using: :btree
    t.index ["parent_order_id"], name: "index_spree_subscriptions_on_parent_order_id", using: :btree
    t.index ["paused"], name: "index_spree_subscriptions_on_paused", using: :btree
    t.index ["ship_address_id"], name: "index_spree_subscriptions_on_ship_address_id", using: :btree
    t.index ["subscription_frequency_id"], name: "index_spree_subscriptions_on_subscription_frequency_id", using: :btree
    t.index ["variant_id"], name: "index_spree_subscriptions_on_variant_id", using: :btree
  end
